...
**Note:** this fork excludes the "App Links" implementation present in the upstream repository, in order to eliminate unwanted code and avoid referencing `UIWebView`.
